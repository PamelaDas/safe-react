...
const CreateSafePageCustomer = React.lazy(() => import('./CreateSafePageCustomer/CreateSafePageCustomer'))
...
const Routes = (): React.ReactElement => {
  ...
  return (
    <Switch>
      ...
      <Route component={CreateSafePageCustomer} exact path={CREATE_SAFE_PAGE_CUSTOMER} />
