...
export const CUSTOMER_FLOW = '/customerFlow'
export const CREATE_SAFE_PAGE_CUSTOMER = '/createSafePageCustomer'
export const CREATE_CUSTOMER_CONFIRMATION = '/createSafeConfrmation'
